'''
PLEASE NOTE: 
This code does not constantly check the status of Arduino connection. It assumes that the Arduino is connected to COM5
...
class ArduinoController():
    ...
    Class Functions
    '''
    # Automatically check Arduino port
    ...
    # Servo write function to Arduino
